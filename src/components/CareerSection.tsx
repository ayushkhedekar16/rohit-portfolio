...
const projects = [
  ...
  {
    title: "Operations Masterclass Promo",
    category: "MOTION GRAPHICS",
    isVertical: true,
    description: "A short-form video outlining a 5-step, 10-minute morning huddle to streamline business operations.",
    keyRole: "Executed post-production by synchronizing animated captions with audio, integrating motion graphics, and pacing b-roll to optimize short-form engagement.",
    video: "https://vimeo.com/1184816511",
